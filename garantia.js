      ...
      submitForm() {
        if (!this.checkbox1 || !this.checkbox2 || !this.checkbox3) {
          this.result.innerHTML = swal("","Por favor acabar con el mantenimiento o revisiones para entrega del vehículo","error");
            ...
            this.result = swal("Entrega del vehículo realizada","Tiene garantía de reparación y respuestos durante 3 meses a partir de la fecha de compra " + date.toLocaleDateString() + " la cual finaliza " + threemonths.toLocaleDateString(),"success");
        }
      }
    }
  });